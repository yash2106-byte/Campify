...
**Campify** is a simplified web-based project management tool inspired by Basecamp. The application focuses on implementing secure **session-based authentication** with a basic UI clone of a project management dashboard.
